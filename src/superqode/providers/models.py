...
MODELS: Dict[str, Dict[str, ModelInfo]] = {
    ...
    # =========================================================================
    # MOONSHOT AI (Kimi, first-party global API)
    # =========================================================================
    "moonshot": {
        "kimi-k3": ModelInfo(
            id="kimi-k3",
            ...
            description="Moonshot's 2.8T flagship for long-horizon coding, knowledge work, and reasoning",
            recommended_for=[
                "long-horizon coding",
                "large codebases",
                "frontend coding",
        ...
        "kimi-k2.7-code-highspeed": ModelInfo(
            ...
            description="High-speed Kimi coding model for iterative agent loops",
        ...
        "kimi-k2.7-code": ModelInfo(
            ...
            description="Stable Moonshot coding model with thinking and native tool use",
            recommended_for=["coding", "repository work"],
            released="2026-07",
        ),
        "kimi-k2.6": ModelInfo(
            id="kimi-k2.6",
            ...
            description="Moonshot general-purpose multimodal model",
            recommended_for=["general", "coding", "vision"],
            released="2026-04",
        ),
    },
