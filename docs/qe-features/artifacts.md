...
SuperQode generates comprehensive artifacts from validation sessions, preserved in `.superqode/qe-artifacts/`.
...
The primary output is a JSON-formatted report:
...
```bash
# Open dashboard for the latest report
...
superqode qe logs qe-session-20240118-143022
```
...
- [report Documentation](../concepts/qr.md) - Report format details
