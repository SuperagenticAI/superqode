...
_LAZY_IMPORTS = {
    ...
    "UHPHarnessProtocolAdapter": (".uhp_adapter", "UHPHarnessProtocolAdapter"),
    "UHP_PROTOCOL_VERSION": (".uhp_client", "UHP_PROTOCOL_VERSION"),
    "UHPClient": (".uhp_client", "UHPClient"),
    "UHPUploadedFile": (".uhp_client", "UHPUploadedFile"),
    "UHPError": (".uhp_client", "UHPError"),
    "UHPHarness": (".uhp_client", "UHPHarness"),
    "UHPResponse": (".uhp_client", "UHPResponse"),
    "UHPStreamEvent": (".uhp_client", "UHPStreamEvent"),
    "UHPServer": (".uhp_server", "UHPServer"),
    "UHPServerConfig": (".uhp_server", "UHPServerConfig"),
    "UHPRunRequest": (".uhp_server", "UHPRunRequest"),
    "UHPRunResult": (".uhp_server", "UHPRunResult"),
    "create_uhp_server": (".uhp_server", "create_uhp_server"),
