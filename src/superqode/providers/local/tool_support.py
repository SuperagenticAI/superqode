...
TOOL_CAPABLE_MODELS: Dict[str, Dict[str, Any]] = {
    ...
    "glm-4": {
        ...
        "parallel_tools": False,
        "tool_choice": ["auto", "none"],
        "notes": "GLM 4.x instruction models support agentic tool calling on modern runtimes",
        "recommended_params": {"num_ctx": 32768},
    },
    "glm4": {
        "supports_tools": True,
    ...
    "glm-5": {
        ...
        "parallel_tools": False,
        "tool_choice": ["auto", "none"],
        "notes": "GLM 5.x is tool-capable; use server-class OpenAI-compatible routes for the largest variants",
        "recommended_params": {"num_ctx": 32768},
    },
    "glm5": {
        "supports_tools": True,
...
def get_tool_capability_info(model_id: str) -> ToolCapabilityInfo:
    ...
    if likely_supports_tools(model_id):
        ...
        return ToolCapabilityInfo(
            ...
            recommended_params={"num_ctx": 32768}
            if family in {"llama", "qwen", "gemma", "glm"}
            else {},
            confidence="heuristic",
    ...
    recommendations = [
        {
            ...
            "context": "262K",
            "notes": "Alibaba models.dev Labs open-weight Qwen recommendation for local/server routes",
        },
        {
            ...
            "context": "262K",
            "notes": "Alibaba models.dev Labs coder route for agentic software work",
        },
        {
            "model": "glm-4.5-air",
            "family": "glm",
            ...
            "coding_quality": "excellent",
            "context": "128K+",
            "notes": "Zhipu AI models.dev Labs open-weight GLM option for agentic coding",
        },
        {
            "model": "glm-4.6",
            "family": "glm",
            ...
            "coding_quality": "excellent",
            "context": "128K+",
            "notes": "Zhipu AI models.dev Labs GLM route; use via vLLM/SGLang/LM Studio or OpenAI-compatible endpoint",
        },
        {
            ...
            "coding_quality": "excellent",
            "context": "1M",
            "notes": "DeepSeek models.dev Labs recommendation; use DS4 or server-class routes",
        },
        {
            "model": "gemma4:26b",
            "family": "gemma",
            ...
            "coding_quality": "very good",
            "context": "262K",
            "notes": "Google models.dev Labs open-weight Gemma option",
        },
        {
            ...
            "coding_quality": "good",
            "context": "128K+",
            "notes": "Mistral models.dev Labs Devstral route for coding agents",
        },
    ]
