...
│        ↓                                                     │
│  6. ADD TO report         Record in Quality Report│
│        ↓                                                     │
...
superqode qe run . --allow-suggestions

# Override other settings
superqode qe run . --allow-suggestions --generate
```
...
Generated by SuperQode validation
"""
