...
def test_every_connection_profile_has_a_sidebar_page(monkeypatch):
    ...
    profile_pages = {
        ...
        "agent-subscriptions": "concepts/modes.md",
        "agent-acp": "concepts/modes.md",
        "protocols": "concepts/modes.md",
        "protocol-acp": "providers/acp.md",
        ...
        "harness-repo": "concepts/modes.md",
        ...
        "plan-zai": "concepts/modes.md",
        "plan-grok": "concepts/modes.md",
        "plan-copilot": "concepts/modes.md",
        "plan-moonshot": "concepts/modes.md",
        "plan-qwen": "concepts/modes.md",
        "plan-opencode": "concepts/modes.md",
        "plan-ollama-cloud": "concepts/modes.md",
        "plan-deepseek": "concepts/modes.md",
        "plan-minimax": "concepts/modes.md",
        ...
        "junie": "concepts/modes.md",
        "junie-key": "concepts/modes.md",
        "muse-key": "concepts/modes.md",
        "qoder-key": "concepts/modes.md",
        "poolside-key": "concepts/modes.md",
        "zcode": "concepts/modes.md",
