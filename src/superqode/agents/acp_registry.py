...
ACP_AGENTS_REGISTRY: dict[str, AgentMetadata] = {
    ...
    "goose.block.xyz": {
        ...
        "status": "available",
        "installation_command": "curl -fsSL https://github.com/aaif-goose/goose/releases/download/stable/download_cli.sh | bash",
    ...
    "stakpak.dev": {
        ...
        "status": "available",
        "installation_command": "curl -sSL https://stakpak.dev/install.sh | sh",
    ...
    "codeassistant.dev": {
        ...
        "status": "available",
        "installation_command": "cargo install --git https://github.com/stippi/code-assistant",
    ...
    "cagent.dev": {
        ...
        "status": "available",
        "installation_command": "brew install docker-agent",
