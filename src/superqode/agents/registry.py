...
AGENTS: Dict[str, AgentDef] = {
    ...
    "goose": AgentDef(
        ...
        setup_command="curl -fsSL https://github.com/aaif-goose/goose/releases/download/stable/download_cli.sh | bash",
    ...
    "stakpak": AgentDef(
        ...
        setup_command="curl -sSL https://stakpak.dev/install.sh | sh",
    ...
    "auggie": AgentDef(
        ...
        setup_command="npm install -g @augmentcode/auggie",
    ...
    "code-assistant": AgentDef(
        ...
        auth_info="API key via config",
        setup_command="cargo install --git https://github.com/stippi/code-assistant",
    ...
    "cagent": AgentDef(
        ...
        auth_info="API key via config",
        setup_command="brew install docker-agent",
