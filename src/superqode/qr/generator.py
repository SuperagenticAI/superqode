...
Produces evidence-backed validation reports for findings from secondary
...
class Finding:
    ...
    # Metadata
    found_by: Optional[str] = None  # validation role that found this
...
"""
    ...
    def _methodology(self) -> str:
        ...
        if self.data.roles_used:
            lines.append("**Validation Roles Used**:")
...
*Generated by SuperQode - Agentic validation and evaluation*
