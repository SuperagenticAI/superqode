"""
Artifact Manager for SuperQode workspace Sessions.

Manages preservation of workspace artifacts that survive the ephemeral workspace reset:
- Candidate fixes / patch files
- Generated tests (unit, integration, fuzz, API, load, regression)
- reports (Quality Investigation Reports)
...
class ArtifactType(Enum):
    """Types of artifacts generated during workspace."""
...
@dataclass
class Artifact:
    """A single artifact from workspace tracking session."""
...
class ArtifactManager:
    """
    Manages workspace artifacts that persist after ephemeral workspace reset.
    ...
    └── artifacts/
        ...
        ├── generated-tests/        # Tests generated by workspace
        │   ├── unit/
        │   ├── integration/
        │   ├── api/
        │   ├── fuzz/
    ...
    def cleanup(self, keep_qirs: bool = True) -> int:
        ...
        Args:
            keep_qirs: If True, keep report files
