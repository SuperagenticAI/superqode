...
| Unified Harness Protocol, UHP | Client **included**; `uv tool install "superqode[uhp]"` to `serve uhp` | `superqode connect uhp --base-url <url>` | `superqode connect uhp --json` | [Unified Harness Protocol](../providers/uhp.md) |
